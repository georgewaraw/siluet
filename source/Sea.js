export default (() => {
  ...
  return (THREE, getRandomNumber, size, setShader, color, map) => sea = (!THREE) ? sea : (() => {
    ...
    const materials = [
      ...
      setShader(values, new THREE.PointsMaterial({ size: 5, transparent: true, opacity: 0.125, map }), 'sea_textured')
    ];
